...
gem 'accounts', git: 'https://github.com/patchwork-hub/accounts', branch: 'mastodon-4.4.18'
gem 'conversations', git: 'https://github.com/patchwork-hub/conversations', branch: 'mastodon-4.4.18'
gem 'faraday-typhoeus', '~> 1.1'
gem 'posts', git: 'https://github.com/patchwork-hub/posts', branch: 'mastodon-4.4.18'
